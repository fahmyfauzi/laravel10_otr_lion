...
<body>
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Lion Air Group</a>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <!-- main -->
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 min-vh-100 pb-5">
                <div
